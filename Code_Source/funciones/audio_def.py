...
import audioop
import time
from .pya_def import find_headset_devices, print_audio_devices
...
async def setup_audio_input(pya, queue):
    ...
    # Get preferred input and output devices
    input_device_index, _ = find_headset_devices()
    
    if input_device_index is None:
        print("Warning: No suitable input device found. Listing available devices:")
        print_audio_devices()
...
async def setup_audio_output(pya):
    ...
    # Get preferred output device
    _, output_device_index = find_headset_devices()
    
    if output_device_index is None:
        print("Warning: No suitable output device found. Listing available devices:")
        print_audio_devices()
