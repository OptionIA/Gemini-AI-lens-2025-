...
from funciones.pya_def import print_audio_devices
...
def start_jarvis(mode):
    while True:
        ...
        # Guardar el modo actual en config.json
        config = load_config()
        config['current_mode'] = mode.lower()
        save_config(config)
...
def set_language(lang_code):
    ...
    save_config(config)
    print_golden_rainbow(f"| [SYS] Idioma configurado a: {lang_code}                     |")

def main_menu():
    while True:
        clear_screen()
        print_header()
        print_golden_rainbow("| [1] Iniciar Jarvis Lentes     [3] Iniciar Conversacional    |")
...
def config_menu():
    while True:
        ...
        print_golden_rainbow("| [7] Configurar Idioma           [8] Volver                  |")
        print_golden_rainbow("|-------------------------------------------------------------|")
        option = get_input("|_>>>: ")
        ...
        if option == '1':
            ...
            print_golden_rainbow("| [SYS] - PayPal: https://paypal.me/optionIA                |")
            print_golden_rainbow("|-------------------------------------------------------------|")
            ...
            clear_screen()
            print_header()
            print_golden_rainbow("| [SYS] Idiomas disponibles:                                  |")
            print_golden_rainbow("| [1] Español (es-US)         [4] Français (fr-FR)           |")
            print_golden_rainbow("| [2] English (en-US)         [5] Deutsch (de-DE)            |")
            print_golden_rainbow("| [3] Português (pt-BR)                                     |")
            print_golden_rainbow("|-------------------------------------------------------------|")
            lang_option = get_input("|_>>>: ")
            ...
            try:
                ...
                if lang_option in lang_codes:
                    set_language(lang_codes[lang_option])
                    print_golden_rainbow(f"| [SYS] Idioma configurado a: {lang_codes[lang_option]}         |")
                else:
                    print_golden_rainbow("| [SYS] Opción inválida                                      |")
            except:
                print_golden_rainbow("| [SYS] Error al configurar el idioma                        |")
            print_golden_rainbow("| [SYS] Presione enter para continuar                        |")
            get_input("|_>>>: ")
