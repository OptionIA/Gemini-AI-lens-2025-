...
from funciones.pya_def import print_audio_devices, find_headset_devices  # Add this import

# Print available audio devices at startup and show selected devices
